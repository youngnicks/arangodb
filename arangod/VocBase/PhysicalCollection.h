...
class PhysicalCollection {
 ...
 public:
  ...
  virtual void insertRevision(TRI_voc_rid_t revisionId, TRI_doc_mptr_t*) = 0;
  virtual void updateRevision(TRI_voc_rid_t oldRevisionId, TRI_voc_rid_t newRevisionId, TRI_doc_mptr_t*) = 0;
