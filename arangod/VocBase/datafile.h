...
*/
  ...
  TRI_WAL_MARKER_MVCC_DOCUMENT             = 4013,
  TRI_WAL_MARKER_MVCC_EDGE                 = 4014,
  TRI_WAL_MARKER_MVCC_REMOVE               = 4015,
  ...
  TRI_WAL_MARKER_MVCC_BEGIN_TRANSACTION    = 4026,
  TRI_WAL_MARKER_MVCC_COMMIT_TRANSACTION   = 4027,
  TRI_WAL_MARKER_MVCC_ABORT_TRANSACTION    = 4028,
...
static inline bool TRI_IsWalDataMarkerDatafile (void const* marker) {
  ...
  return (m->_type == TRI_WAL_MARKER_DOCUMENT || 
          ...
          m->_type == TRI_WAL_MARKER_MVCC_DOCUMENT ||
          m->_type == TRI_WAL_MARKER_MVCC_EDGE);
}
