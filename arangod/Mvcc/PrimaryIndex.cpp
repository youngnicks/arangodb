...
////////////////////////////////////////////////////////////////////////////////
/// @brief iterate over the documents present in the index (this is called when
/// opening a collection only)
/// this method does not require locking
////////////////////////////////////////////////////////////////////////////////
        
void PrimaryIndex::iterate (std::function<void(struct TRI_doc_mptr_t*)> iterator) {
  _theHash->iterate(iterator);
}
