...
triagens::arango::CollectionNameResolver const* SubTransaction::resolver () {
  return topLevelTransaction()->resolver();
}
...
void SubTransaction::resolver (triagens::arango::CollectionNameResolver const* resolver) {
  topLevelTransaction()->resolver(resolver);
}
