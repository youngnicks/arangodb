...
TRI_voc_cid_t TransactionCollection::planId () const {
  return _collection->_collection->_info._planId;
}
...
char const* TransactionCollection::dbName () const {
  return _collection->_dbName;
}
...
bool TransactionCollection::isVolatile () const {
  return _collection->_collection->_info._isVolatile;
}
...
bool TransactionCollection::isEdgeCollection () const {
  return type() == TRI_COL_TYPE_EDGE;
}
