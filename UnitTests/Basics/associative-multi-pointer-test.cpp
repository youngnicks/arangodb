...
static bool IsEqualElementElement (void const* l, void const* r, bool byKey) {
...
struct CMultiPointerSetup {
  CMultiPointerSetup () {
    BOOST_TEST_MESSAGE("setup TRI_associative_multi_pointer_t");
  }

  ~CMultiPointerSetup () {
    BOOST_TEST_MESSAGE("tear-down TRI_associative_multi_pointer_t");
  }
};
